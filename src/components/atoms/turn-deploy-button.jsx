...
const TurnDeployButton = ({ handleDeployTroops, turnState, isMyTurn }) => {

	return (
		<button
			disabled={!isMyTurn || turnState > 0}
		...
		>
			...
			<img className="w-10" src="public/parachute.svg"/>
			{ isMyTurn && turnState == 0 &&
