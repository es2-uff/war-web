...
const GameInfoSidebar = ({ userId, players, gameState, selectedTerritory, territories, turnState, isMyTurn, handleTroopAssign, handleAttackTerritory, handleTroopMove }) => {
	return (
