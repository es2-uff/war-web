...
const TurnControls = ({  handleDeployTroops, handleFinishTurn, handleSetAttackTurnState, handleSetMoveTurnState, turnState, isMyTurn }) => {
		...
		<div className="absolute left-1/2 -translate-x-1/2 px-6 py-3 flex items-center justify-center bottom-38.5 gap-x-4 bg-gradient-to-b from-[rgba(20,20,30,0.95)] to-[rgba(10,10,20,0.95)] rounded-t-2xl">
			{isMyTurn || turnState === -1 ? (
				<>
					...
					<TurnAttackButton handleSetAttackTurnState={handleSetAttackTurnState} turnState={turnState} />
					<TurnMoveButton handleSetMoveTurnState={handleSetMoveTurnState} turnState={turnState} />
